        ...
        // Basic Information
        {
          ...
          inputs: [
            { name: "aImage", label: "Image", type: "file",
              ...
              onUpdate: (event: any, form: any, fieldName: string) => singleImageCreateHandleChangeUtility(event, form, "inventech_base", fieldName),
              onDelete: (event: any, form: any, fieldName: string) => singleImageCreateHandleChangeUtility(event, form, "inventech_base", fieldName),
            },
