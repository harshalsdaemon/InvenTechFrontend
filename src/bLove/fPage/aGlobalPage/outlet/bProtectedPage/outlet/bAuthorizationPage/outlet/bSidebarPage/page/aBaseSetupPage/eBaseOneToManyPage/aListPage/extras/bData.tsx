...
const data = (APICall: any) => {
  return ({
    header: {
      title: "Base One To Many List",
      subtitle: "Here's a list of your tasks for this month!",
      buttons: [
        { label: "Create Base One To Many", to: fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.aBaseSetupRoute.eBaseOneToManyRoute.bCreateRoute }
      ]
    },
    content: {
