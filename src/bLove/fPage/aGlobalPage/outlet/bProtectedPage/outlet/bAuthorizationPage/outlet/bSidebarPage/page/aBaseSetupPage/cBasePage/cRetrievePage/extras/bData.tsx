            ...
            APICall.retrieveAPIResponse.isSuccess ? (
              APICall.retrieveAPIResponse.data.success ? ([
                ...
                // Relation Information
                {
                  ...
                  values: [
                    { label: "BaseOneToOne", value: APICall.retrieveAPIResponse.data.retrieve.cBaseOneToOne?.aTitle, type: "normal" },
                    { label: "BaseOneToMany", value: APICall.retrieveAPIResponse.data.retrieve.cBaseOneToMany?.map((each: any) => each.aTitle).join(", "), type: "normal" },
                    { label: "BaseManyToOne", value: APICall.retrieveAPIResponse.data.retrieve.cBaseManyToOne?.aTitle, type: "normal" },
                    { label: "BaseManyToMany", value: APICall.retrieveAPIResponse.data.retrieve.cBaseManyToMany?.map((each: any) => each.aTitle).join(", "), type: "normal" },
                  ],  
                },
