...
import {
  ...
  CommandList,
  CommandSeparator,
} from "@/aConnection/bShadcnConnection/components/ui/command"
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from "@/aConnection/bShadcnConnection/components/ui/dialog"
        ...
        <div>
          <div className="space-y-4 py-2 pb-4">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="PegaSYS - Admin." />
            </div>
            <div className="space-y-2">
