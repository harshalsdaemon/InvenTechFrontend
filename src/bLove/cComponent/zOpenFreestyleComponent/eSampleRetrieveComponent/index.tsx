...
import SampleMiniListComponent from "../cSampleMiniListComponent";


// type SampleRetrieveComponentType = {
  // ReduxCall: any
  // APICall: {
...
const SampleRetrieveComponent = () => {
  ...
  return (
    <React.Fragment>
      ...
      <div className="mx-auto grid flex-1 auto-rows-max gap-4 p-4">
        {/* {
                          ...
                          <React.Fragment>
                            {((eachValue.type === "normal" &&
                              <li className={cn("flex flex-col gap-1 items-start justify-between", eachValue?.style)} key={indexValue} >
                                ...
                                <span className="w-4/5 truncate text-xl" >{eachValue.value || "--N/A--"}</span>
                              </li>
                            ))}
...
export default SampleRetrieveComponent;
