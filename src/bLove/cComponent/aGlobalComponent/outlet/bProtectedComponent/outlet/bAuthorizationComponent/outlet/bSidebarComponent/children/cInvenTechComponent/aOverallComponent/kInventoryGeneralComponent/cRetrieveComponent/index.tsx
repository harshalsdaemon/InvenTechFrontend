...
// type InventoryGeneralRetrieveComponentType = {
  // ReduxCall: any
  // APICall: {
...
const InventoryGeneralRetrieveComponent = () => {
  // Destructure Props
  ...
  return (
    <React.Fragment>
      {/* InventoryGeneralRetrieveComponent */}
      <div className="flex-1 space-y-8">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Stock Item Information
            </h2>
                                  ...
                                  <Table>
                                    <TableHeader className="bg-gray-300" >
                                      <TableRow>
                                        ...
                                        <TableHead className="w-[150px]">Avg. Purch/SKU (AED)</TableHead>
                                        <TableHead className="w-[150px]">Total Cost (AED)</TableHead>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell className="font-medium">34.78</TableCell>
                                        <TableCell className="font-medium">39.99</TableCell>
                                        <TableCell className="font-medium">UAE</TableCell>
                                        <TableCell className="font-medium">Vinayak Tubes</TableCell>
...
export default InventoryGeneralRetrieveComponent;
