...
type OrganizationRoleCreateComponentType = {
  // ReduxCall: any
  // APICall: {
...
const OrganizationRoleCreateComponent = (_props: OrganizationRoleCreateComponentType) => {
  // // Destructure Props
      ...
      <div className="flex-1">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <h1 className="text-xl mb-0" >Access Control</h1>
            <Table>
              ...
              <TableBody>
                ...
                >
                  <TableCell className="font-medium">Store Manageent</TableCell>
                ...
                <TableRow
                  className="odd:bg-white odd:dark:bg-gray-800 even:bg-blue-50 even:dark:bg-gray-900"
                >
                  <TableCell className="font-medium">Warehouse Management</TableCell>
                  <TableCell className="font-medium"><input type="checkbox" /></TableCell>
                  <TableCell className="font-medium"><input type="checkbox" /></TableCell>
                  <TableCell className="font-medium"><input type="checkbox" /></TableCell>
                  <TableCell className="font-medium"><input type="checkbox" /></TableCell>
            ...
            <div className="flex justify-between" >
              <Button type="button" variant="destructive" asChild >
                <Link to={fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cInvenTechRoute.aOverallRoute.hOrganizationRoleRoute.aListRoute} >
                  Cancel
                </Link>
              </Button>
...
export default OrganizationRoleCreateComponent;
