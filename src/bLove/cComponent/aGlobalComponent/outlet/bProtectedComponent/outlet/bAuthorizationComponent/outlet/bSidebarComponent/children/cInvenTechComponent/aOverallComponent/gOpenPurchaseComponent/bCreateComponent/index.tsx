...
type OpenPurchaseOrderCreateComponentType = {
  // ReduxCall: any
  // APICall: {
...
const OpenPurchaseOrderCreateComponent = (_props: OpenPurchaseOrderCreateComponentType) => {
  // // Destructure Props
...
export default OpenPurchaseOrderCreateComponent;
