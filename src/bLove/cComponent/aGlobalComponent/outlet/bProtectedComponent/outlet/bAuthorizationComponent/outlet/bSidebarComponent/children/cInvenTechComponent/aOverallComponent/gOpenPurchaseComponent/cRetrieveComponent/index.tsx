...
// type OpenPurchaseOrderRetrieveComponentType = {
  // ReduxCall: any
  // APICall: {
...
const OpenPurchaseOrderRetrieveComponent = () => {
  // Destructure Props
    ...
    <React.Fragment>
      ...
      <div className="flex-1 space-y-8">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Open Purchase Order Information
            </h2>
                ...
                <Tabs defaultValue="product-list" className="w-full">
                  ...
                  <TabsContent value="product-list" className='flex flex-col gap-4' >
                    <span className="w-full flex flex-row align-middle items-center gap-4" >
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button variant="blue" size="sm" ><PlusIcon /> Add Received</Button>
                        </DialogTrigger>
                        <DialogContent>
                          <DialogHeader>
                            <DialogTitle>Add Received</DialogTitle>
                            {/* <DialogDescription>
                              Anyone who has this link will be able to view this.
                            </DialogDescription> */}
                          </DialogHeader>
                          ...
                          <ul className="grid gap-4 grid-cols-5">
                            <li className={cn("flex flex-col gap-1 items-start justify-between col-span-3")} >
                              <span className="text-muted-foreground text-sm">
                                {"Store Name"}:
                              </span>
                              <span className="w-4/5 truncate text-lg" >{"Dubai Center"}</span>
                            ...
                            <li className={cn("flex flex-col gap-1 items-start justify-between col-span-2")} >
                              <span className="text-muted-foreground text-sm">
                                {"Enter Quantity"}:
                              </span>
                              <Input />
                            ...
                            <li className={cn("flex flex-col gap-1 items-start justify-between col-span-2")} >
                              ...
                              <span className="w-4/5 truncate text-lg" >{"Lo'real Shampoo"}</span>
                            </li>
                            <li className={cn("flex flex-col gap-1 items-start justify-between")} >
                              <span className="text-muted-foreground text-sm">
                                {"SKU ID"}:
                              </span>
                              <span className="w-4/5 truncate text-lg" >{"1234"}</span>
                            </li>
                            <li className={cn("flex flex-col gap-1 items-start justify-between")} >
                              <span className="text-muted-foreground text-sm">
                                {"Type"}:
                              </span>
                              <span className="w-4/5 truncate text-lg" >{"Shampoo"}</span>
                            </li>
                            <li className={cn("flex flex-col gap-1 items-start justify-between")} >
                              <span className="text-muted-foreground text-sm">
                                {"Price (AED-Supplier)"}:
                              </span>
                              <span className="w-4/5 truncate text-lg" >{"822.22"}</span>
                            </li>
                          </ul>
...
export default OpenPurchaseOrderRetrieveComponent;
