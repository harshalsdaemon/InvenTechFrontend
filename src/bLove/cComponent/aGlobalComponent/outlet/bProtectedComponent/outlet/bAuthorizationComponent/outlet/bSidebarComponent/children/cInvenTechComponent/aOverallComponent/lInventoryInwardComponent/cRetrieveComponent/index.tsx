...
// type InventoryInwardRetrieveComponentType = {
  // ReduxCall: any
  // APICall: {
...
const InventoryInwardRetrieveComponent = () => {
  // Destructure Props
  ...
  return (
    <React.Fragment>
      {/* InventoryInwardRetrieveComponent */}
...
export default InventoryInwardRetrieveComponent;
