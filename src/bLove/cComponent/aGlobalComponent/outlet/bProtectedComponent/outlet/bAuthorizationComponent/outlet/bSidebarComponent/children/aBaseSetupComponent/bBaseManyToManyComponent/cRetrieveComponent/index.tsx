...
type BaseManyToManyRetrieveComponentType = {
  ReduxCall: any
  APICall: {
...
const BaseManyToManyRetrieveComponent = (props: BaseManyToManyRetrieveComponentType) => {
  // Destructure Props
...
export default BaseManyToManyRetrieveComponent;
