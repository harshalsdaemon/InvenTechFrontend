...
type DepartmentCreateComponentType = {
  // ReduxCall: any
  // APICall: {
...
const DepartmentCreateComponent = (_props: DepartmentCreateComponentType) => {
  // // Destructure Props
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-between" >
              <Button type="button" variant="destructive" asChild >
                <Link to={fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cInvenTechRoute.aOverallRoute.fDepartmentRoute.aListRoute} >
                  Cancel
                </Link>
              </Button>
...
export default DepartmentCreateComponent;
