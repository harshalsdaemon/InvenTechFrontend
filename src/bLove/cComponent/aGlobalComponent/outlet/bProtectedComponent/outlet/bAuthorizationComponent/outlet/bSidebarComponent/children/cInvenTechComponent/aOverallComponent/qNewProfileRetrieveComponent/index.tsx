...
import { CheckCircle, Edit2Icon, OctagonMinus } from "lucide-react";
import { Link } from "react-router-dom";
import SampleMiniListComponent from "./component/aSampleMiniListComponent";
import data from "./extras/bData";


// type NewProfileRetrieveComponentType = {
  // ReduxCall: any
  // APICall: {
...
const NewProfileRetrieveComponent = () => {
  // Destructure Props
  ...
  return (
    <React.Fragment>
      {/* NewProfileRetrieveComponent */}
      <div className="flex-1 space-y-8">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Profile
            </h2>
...
export default NewProfileRetrieveComponent;
