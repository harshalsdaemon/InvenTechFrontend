...
type BaseManyToOneUpdateComponentType = {
  ReduxCall: any
  APICall: {
...
const BaseManyToOneUpdateComponent = (props: BaseManyToOneUpdateComponentType) => {
  // Destructure Props
...
export default BaseManyToOneUpdateComponent;
