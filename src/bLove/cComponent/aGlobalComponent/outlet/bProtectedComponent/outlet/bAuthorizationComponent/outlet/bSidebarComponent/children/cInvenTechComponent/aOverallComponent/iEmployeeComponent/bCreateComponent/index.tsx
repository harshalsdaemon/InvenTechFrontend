...
type EmployeeCreateComponentType = {
  // ReduxCall: any
  // APICall: {
...
const EmployeeCreateComponent = (_props: EmployeeCreateComponentType) => {
  // // Destructure Props
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-4 gap-4">
                  {eachSection.inputs.map((eachInput: any, indexInput: any) => (
                    <React.Fragment>
                      ...
                      {/* For I/P Type: Search & Select */}
                      {((eachInput.type === "search-and-select") && 
                        <div className={`grid gap-3 ${eachInput?.style}`} key={indexInput} >
                          <FormField
                            control={form.control}
                            name={eachInput.name}
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription>{eachInput.description}</FormDescription>
                                <FormMessage />
                              </FormItem>
                            )}
                          />
            ...
            <div className="flex justify-between" >
              <Button type="button" variant="destructive" asChild >
                <Link to={fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cInvenTechRoute.aOverallRoute.iEmployeeRoute.aListRoute} >
                  Cancel
                </Link>
              </Button>
