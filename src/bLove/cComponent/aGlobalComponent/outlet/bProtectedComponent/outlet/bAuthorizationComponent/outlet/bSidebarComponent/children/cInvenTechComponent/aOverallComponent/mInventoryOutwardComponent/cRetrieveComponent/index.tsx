...
// type InventoryOutwardRetrieveComponentType = {
  // ReduxCall: any
  // APICall: {
...
const InventoryOutwardRetrieveComponent = () => {
  // Destructure Props
  ...
  return (
    <React.Fragment>
      {/* InventoryOutwardRetrieveComponent */}
...
export default InventoryOutwardRetrieveComponent;
