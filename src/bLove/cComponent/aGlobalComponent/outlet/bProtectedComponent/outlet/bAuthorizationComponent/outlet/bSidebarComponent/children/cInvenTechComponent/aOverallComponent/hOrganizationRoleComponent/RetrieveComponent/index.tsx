...
// type OrganizationRoleRetrieveComponentType = {
  // ReduxCall: any
  // APICall: {
...
const OrganizationRoleRetrieveComponent = () => {
  // Destructure Props
  ...
  return (
    <React.Fragment>
      {/* OrganizationRoleRetrieveComponent */}
      <div className="flex-1 space-y-8">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Role Information
            </h2>
          ...
          <div className="hidden lg:flex items-center space-x-2">
            <Button asChild variant="blue" >
              <Link to={fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cInvenTechRoute.aOverallRoute.hOrganizationRoleRoute.bCreateRoute} ><Edit2Icon /> Edit</Link>
            </Button>
                              ...
                              {((eachValue.type === "normal-list" &&
                                <li className={cn("flex flex-col gap-4 items-start justify-between col-span-5", eachValue?.style)} key={indexValue} >
                                  ...
                                  <Table>
                                    ...
                                    <TableBody>
                                      <TableRow
                                        className="odd:bg-white odd:dark:bg-gray-800 even:bg-blue-50 even:dark:bg-gray-900"
                                      >
                                        <TableCell className="font-medium">Accountant</TableCell>
                                        <TableCell className="font-medium"><CrossCircledIcon className="h-6 w-6 text-red-600" /></TableCell>
                                        <TableCell className="font-medium"><CheckCircledIcon className="h-6 w-6 text-green-600" /></TableCell>
                                        <TableCell className="font-medium"><CrossCircledIcon className="h-6 w-6 text-red-600" /></TableCell>
                                        <TableCell className="font-medium"><CheckCircledIcon className="h-6 w-6 text-green-600" /></TableCell>
                                        <TableCell className="font-medium"><CrossCircledIcon className="h-6 w-6 text-red-600" /></TableCell>
                                      </TableRow>
...
export default OrganizationRoleRetrieveComponent;
