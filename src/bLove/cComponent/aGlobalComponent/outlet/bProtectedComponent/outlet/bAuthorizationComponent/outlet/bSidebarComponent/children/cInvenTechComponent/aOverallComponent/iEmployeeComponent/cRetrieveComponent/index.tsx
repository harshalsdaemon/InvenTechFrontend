...
// type EmployeeRetrieveComponentType = {
  // ReduxCall: any
  // APICall: {
...
const EmployeeRetrieveComponent = () => {
  // Destructure Props
    ...
    <React.Fragment>
      ...
      <div className="flex-1 space-y-8">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Employee Information
            </h2>
          ...
          <div className="hidden lg:flex items-center space-x-2">
            <Button asChild variant="blue" >
              <Link to={fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cInvenTechRoute.aOverallRoute.iEmployeeRoute.bCreateRoute} ><Edit2Icon /> Edit</Link>
            </Button>
...
export default EmployeeRetrieveComponent;
