...
type NewProfileEditComponentType = {
  // ReduxCall: any
  // APICall: {
...
const NewProfileEditComponent = (_props: NewProfileEditComponentType) => {
  // // Destructure Props
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <ul className="grid gap-3 grid-cols-5">
              <li className={cn("flex flex-col gap-1 items-start justify-between col-span-3")} >
                ...
                <span className="w-4/5 truncate text-md underline" >hello@inventech.com</span>
                <span className="w-4/5 truncate text-md text-red-600" >Request Admin to change Email</span>
              </li>
            </ul>
...
export default NewProfileEditComponent;
