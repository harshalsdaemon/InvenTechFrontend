...
type InventoryInwardCreateComponentType = {
  // ReduxCall: any
  // APICall: {
...
const InventoryInwardCreateComponent = (_props: InventoryInwardCreateComponentType) => {
  // // Destructure Props
...
export default InventoryInwardCreateComponent;
