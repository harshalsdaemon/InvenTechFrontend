...
type LocationCreateComponentType = {
  // ReduxCall: any
  // APICall: {
...
const LocationCreateComponent = (_props: LocationCreateComponentType) => {
  // // Destructure Props
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-between" >
              <Button type="button" variant="destructive" asChild >
                <Link to={fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cInvenTechRoute.aOverallRoute.eLocationRoute.aListRoute} >
                  Cancel
                </Link>
              </Button>
